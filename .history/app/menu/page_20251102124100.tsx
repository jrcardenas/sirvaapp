    ...
    <main className="min-h-screen bg-[#EFEFEF] p-4 pb-32 max-w-md mx-auto">
      ...
      {categorias.map((categoria) => (
        <div key={categoria} className="mb-5">
          ...
          {/* ✅ Botón de categoría con icono + texto */}
          <button
            className="w-full flex justify-between items-center text-lg font-semibold py-2 text-left"
                  ...
                  return (
                    <div key={item.id} className="flex justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`w-6 text-center font-semibold ${qty === 0 ? "text-gray-400" : "text-black"}`}>
                          {qty}
                        </span>
