...
export default function Header() {
  ...
  // ✅ Prepara sonido (solo se reproduce cuando responde camarero)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    notify.onmessage = (ev) => {
      ...
      if (data.mensaje === "camareroEnCamino") {
  ...
  // ✅ Cliente confirma que quiere llamar
  ...
  return (
    <>
      ...
      {/* ✅ Toast cuando camarero responde */}
      {showToast && (
        <div className="fixed bottom-24 left-1/2 -translate-x-1/2 bg-green-600 text-white px-4 py-2 rounded-full shadow-xl font-bold animate-fadeInOut">
