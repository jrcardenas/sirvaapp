...
export default function Header() {
  ...
  const navItems = [
    ...
    { href: mesaId ? `/mesa/${mesaId}/menu` : "/", label: "Menú", icon: "🍽️", visible: !!mesaId },
    { href: mesaId ? `/mesa/${mesaId}/cuenta` : "/", label: "Cuenta", icon: "🧾", visible: !!mesaId },
    { label: llamada ? "Esperando" : "Llamar", icon: "🛎️", visible: !!mesaId, action: "call" },
    { href: mesaId ? `/mesa/${mesaId}/info` : "/", label: "Info", icon: "ℹ️", visible: !!mesaId },
  ];
