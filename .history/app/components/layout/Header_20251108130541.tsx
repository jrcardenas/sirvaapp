...
export default function Header() {
  ...
  // 🎵 Prepara sonido ✅ pero solo se usa cuando responde el camarero
  useEffect(() => {
    dingRef.current = new Audio("/sounds/ding.mp3");
    dingRef.current!.volume = 1;
  }, []);

  // ✅ Escucha cuando el camarero responde
  useEffect(() => {
    if (!mesaId) return;
  ...
  // ✅ Llamar camarero: ya NO suena aquí para evitar doble sonido
