  ...
  return (
    <div
      ...
      className={`flex justify-between items-center p-3 rounded-xl mb-2 ${
        bloqueado ? "bg-gray-100 opacity-70" : "bg-yellow-100"
      }`}
    >
...
{destino === "cocina" && (
  <button
    className={`px-3 py-1 rounded-lg font-bold text-white transition-all duration-150 ${
      preparados.length === 0
        ? "bg-green-400/50 cursor-not-allowed"
        : "bg-green-600 hover:bg-green-1000 shadow-md hover:shadow-lg"
    }`}
