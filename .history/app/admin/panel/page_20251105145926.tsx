          ...
          {mesasActivas.map(([mesaId, mesa]) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between font-bold py-2 mb-3 px-2 bg-primaryLight/20 rounded-lg text-primary">
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="flex justify-between font-bold border-t border-gray-300 pt-2 mb-5 text-lg">
                    <span>Total</span>
