...
export default function AdminPanel() {
  ...
  useEffect(() => {
    ...
    pedidos.onmessage = (ev) => {
      ...
      // ✅ La mesa está llamando
      if (ev.data?.llamada && ev.data?.mesaId) {
        atenderLlamada(ev.data.mesaId); // Cambia llamada a true
        dingRef.current?.play().catch(() => null);
      }
    };
                ...
                {agrupados
                  ...
                  .map(item => (
                    <div
                      ...
                      ${mesa.llamada ? "bg-red-200" : "bg-yellow-100"}`}
                    >
