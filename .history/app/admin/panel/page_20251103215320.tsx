  ...
  return (
    <main className="min-h-screen bg-zinc-100 p-5 pt-24 max-w-lg mx-auto relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 bg-red-600 text-white px-3 py-1 rounded font-bold shadow-md"
      >
        🔓 Salir
      </button>
      ...
      {!soundReady && (
        <div className="flex justify-center mb-4">
          <button
            className="px-3 py-1 rounded bg-black text-white text-sm shadow-sm"
            onClick={() => {
