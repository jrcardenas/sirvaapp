...
export default function AdminPanel() {
  ...
  useEffect(() => {
    ...
    pedidos.onmessage = (ev) => {
      ...
      // ✅ FIX: fuerza actualización del estado y UI
      if (data.mesas) {
        useOrderStore.setState({ mesas: { ...data.mesas } });
      }

      // ✅ Mantener el sonido excepto cuando es añadido por camarero
      if (
...
/* ✅ Modal Cobro con items agrupados */
function ModalCobro({
  mesaParaCobrar,
  setMesaParaCobrar,
}: {
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 w-80 text-gray-900 shadow-xl">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            className="w-full bg-gray-300 text-gray-800 py-3 rounded-xl font-semibold text-lg"
          ...
          <button
            disabled
            className="w-full bg-blue-600 text-white py-3 rounded-xl font-bold text-lg opacity-50 cursor-not-allowed"
          >
