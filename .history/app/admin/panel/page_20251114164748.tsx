            ...
            <div key={mesaId} className="p-4 rounded-2xl border shadow bg-white">
              ...
              {(agrupados.filter((i) => i.pendientes > 0) ?? []).map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`flex flex-wrap justify-between items-center p-3 rounded-xl mb-2 ${
                  ...
                  >
                    <div className="flex flex-col w-full sm:w-auto">
                      ...
                      <div className="mt-1 text-xs text-gray-700 flex gap-2">
                        {pendientes.length > 0 && <span>🟡 {pendientes.length}</span>}
                        {enColaCocina.length > 0 && <span>🟨 {enColaCocina.length}</span>}
                        {preparando.length > 0 && <span>🟠 {preparando.length}</span>}
                        {preparados.length > 0 && <span>🟢 {preparados.length}</span>}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 justify-end w-full sm:w-auto mt-2 sm:mt-0">
                      ...
                      {destino === "cocina" ? (
                        <button
                          className={`px-3 py-1 rounded-lg font-bold text-white text-xs sm:text-sm w-full sm:w-auto ${
                        ...
                        <button
                          className="bg-purple-600 text-white px-3 py-1 rounded-lg font-bold text-xs sm:text-sm w-full sm:w-auto"
                      ...
                      {destino === "cocina" && (
                        <button
                          className={`bg-primary text-white px-3 py-1 rounded-lg font-bold text-xs sm:text-sm w-full sm:w-auto ${
