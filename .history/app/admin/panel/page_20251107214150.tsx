    ...
    >
      <div className="flex flex-col">
        ...
        <div className="mt-1 text-xs text-gray-700 flex gap-2">
          ...
          {enColaCocina.length > 0 && <span>🟨 {enColaCocina.length} en cola cocina</span>}
      ...
      <div className="flex items-center gap-2">
        ...
        {/* 📤 Confirmar → pasa a 'pendienteCocina' */}
        <button
...
/* ✅ Modal editable de cobro igual al del camarero */
