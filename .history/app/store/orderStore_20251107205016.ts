...
export type PedidoItem = {
  ...
  estado?: "pendiente" | "pendienteCocina" | "enCocina" | "listo";
};
...
const markServido = (items: PedidoItem[], timestamp: number): PedidoItem[] =>
  items.map((i) =>
    i.timestamp === timestamp
      ? { ...i, entregado: true, estado: "listo" } satisfies PedidoItem
      : i
  );
...
export const useOrderStore = create<OrderStore>()(
  persist(
    (set, get) => ({
      ...
      // ✅ Confirmación: pasa a "pendienteCocina"
    ...
    }),
    {
      ...
      storage:
        typeof window !== "undefined"
          ...
          : undefined,
      migrate: (persistedRaw: unknown): OrderStore => {
