...
type SyncEvent = {
  tipo?:
    | "nuevoPedido"
    | "pedidoConfirmado"
    | "pedidoServido" // ✅ nuevo evento para cuando el pedido se sirve
    | "llamada"
    | "llamadaAtendida"
    | "cuenta"
    | "cuentaAtendida"
...
marcarServido: (mesaId, timestamp) => {
  ...
  // 🔊 Emitimos evento de sincronización claro
  get()._sync({ tipo: "pedidoServido", mesaId: key });

  // 🔔 Además, avisamos explícitamente al cliente (opcional, pero útil)
