...
export const useOrderStore = create<OrderStore>()(
  persist(
    (set, get) => ({
      ...
      // ✅ SONIDO: solo cuando el cliente hace pedido
      ...
      // ❌ SIN sonido: acción del camarero
      ...
      // ❌ SIN sonido: camarero atiende cuenta
      ...
      // ❌ SIN sonido: camarero atiende llamada
