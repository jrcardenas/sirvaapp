...
export type PedidoItem = {
  ...
  estado?: "pendiente" | "confirmado" | "enCocina" | "listo"; // 👈 cocina usa "enCocina" como "preparando"
};
...
type OrderStore = {
  ...
  confirmarItem: (mesaId: string, timestamp: number) => void;
  ...
  persist(
    (set, get) => ({
      ...
      confirmarItem: (mesaId, timestamp) => {
        ...
        set({
          mesas: { ...state, [mesaId]: { ...mesa, items: nuevos } },
        });
