                    ...
                    <div key={item.id} className="flex justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className={`w-7 h-7 rounded-full border text-sm font-bold transition ${
                            qty === 0
                              ? "border-gray-300 text-gray-400 opacity-40"
                        ...
                        {/* Botón sumar */}
                        <button
                          className="w-7 h-7 rounded-full bg-primary text-white text-sm font-bold active:scale-95"
                          onClick={() =>
                            addItem({
                              id: item.id,
                              name: item.nombre,
