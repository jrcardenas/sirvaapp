...
export default function MenuPage() {
  ...
  useEffect(() => {
    ...
    notify.onmessage = (ev) => {
      ...
      // 🍽 Pedido en camino (cuando camarero marca “Servir”)
      if (ev.data?.mensaje === "pedidoEnCamino" || ev.data?.mensaje === "pedidoServido") {
        setToastPedido(true);
      ...
      // 💳 Cuenta en camino
      if (
        ev.data?.mensaje === "cuentaEnPreparacion" ||
        ev.data?.mensaje === "cuentaEnCamino"
      ) {
        setToastCuenta(true);
        setTimeout(() => setToastCuenta(false), 3000);
      }

      // ✅ Nuevo: aviso explícito de pedido servido
      if (ev.data?.mensaje === "pedidoServido") {
