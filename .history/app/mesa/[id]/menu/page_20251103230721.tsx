...
export default function MenuPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-surface p-5 pb-32 max-w-md mx-auto pt-14">
                  ...
                  return (
                    <div key={item.id} className="flex justify-between items-center mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {/* ✅ Botón restar con clases globales */}
                        <button
                          disabled={qty === 0}
                          onClick={() =>
                          ...
                          className={`btn-minus ${
                            qty === 0 ? "btn-minus-disabled" : "btn-minus-active"
                          }`}
                        >
                          -
                        </button>
                        ...
                        {/* ✅ Botón sumar con clases globales */}
                        <button
                          className="btn-plus"
                          onClick={() =>
                            addItem({
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-5 w-80 shadow-xl">
            ...
            <div className="flex gap-2">
              <button className="w-1/2 py-2 bg-gray-300 rounded-lg font-semibold"
                onClick={() => setShowConfirm(false)}
              >
                ❌ Cancelar
              </button>

              <button className="w-1/2 py-2 bg-primary text-white rounded-lg font-semibold"
