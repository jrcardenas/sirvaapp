  ...
  return (
    <>
      <main className="min-h-screen bg-[var(--color-background)] p-4 pb-32 max-w-md mx-auto pt-14">
                  ...
                  return (
                    <div key={item.id} className="flex justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm">{item.precio.toFixed(2)} €</p>
                      </div>
        ...
        {total > 0 && (
          <div className="fixed bottom-0 left-0 w-full bg-[var(--color-surface)] p-4 border-t shadow-lg">
            <div className="max-w-md mx-auto flex justify-between text-lg font-bold mb-3">
              <span>Total</span>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-5 w-80 shadow-xl">
            ...
            <div className="flex gap-2">
              <button className="w-1/2 py-2 bg-gray-300 rounded-lg"
