  ...
  return (
    <>
      <main className="min-h-screen bg-background p-5 pb-32 max-w-md mx-auto pt-14 text-textDark">
        ...
        {total > 0 && (
          <div className="fixed bottom-0 left-0 w-full backdrop-blur-md bg-surface/95 border-t border shadow-lg transition">
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-surface rounded-2xl p-5 w-80 shadow-xl">
            <h3 className="text-lg font-bold text-center mb-4">Confirmar Pedido</h3>
      ...
      {showToast && (
        <div className="fixed bottom-32 left-1/2 -translate-x-1/2 bg-primaryLight text-white px-4 py-2 rounded-xl shadow-lg animate-toast font-semibold">
