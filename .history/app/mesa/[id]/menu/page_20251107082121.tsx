...
export default function MenuPage() {
  ...
  // ✅ Confirmación con popup del pedido total
      ...
      <main className="min-h-screen bg-white p-5 pb-40 max-w-md mx-auto pt-14">
        ...
        {mesaActual?.items?.length > 0 && (
          <div className="bg-gray-100 p-4 rounded-xl mb-6">
            ...
            {Object.values(
              mesaActual.items.reduce<Record<string, PedidoAgrupado>>(
                (acc, item) => {
                  if (!acc[item.id]) {
                    acc[item.id] = {
                      id: item.id,
          ...
          <div className="bg-white p-6 rounded-2xl w-80 shadow-xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="w-1/2 bg-gray-300 text-gray-800 py-2 rounded-lg font-semibold"
              >
                ❌ Cancelar
              </button>
              ...
              <button
                ...
                className="w-1/2 bg-green-600 text-white py-2 rounded-lg font-bold"
              >
                ✅ Confirmar
              </button>
            </div>
