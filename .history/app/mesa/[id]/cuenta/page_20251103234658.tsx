...
export default function MenuPage() {
  ...
  return (
    <>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-80 shadow-xl">
            ...
            <div className="flex gap-2">
              <button
                className="w-1/2 py-2 bg-disabledBg rounded-xl font-semibold"
              ...
              <button
                className="w-1/2 bg-primaryLight text-white font-bold py-3 rounded-2xl shadow-md active:scale-95 transition"
      ...
      {showToast && (
        <div className="fixed bottom-32 left-1/2 -translate-x-1/2 bg-primaryLight text-white px-4 py-2 rounded-lg shadow-lg animate-toast">
