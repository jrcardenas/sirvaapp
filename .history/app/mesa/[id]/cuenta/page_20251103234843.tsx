...
export default function CuentaPage() {
  ...
  return (
    <>
        ...
        <div className="fixed bottom-0 left-0 w-full bg-surface border-t border-border shadow-lg">
          <div className="max-w-md mx-auto p-4">
            ...
            <Button
              ...
              className={`w-full py-3 rounded-2xl shadow-md active:scale-95 transition font-semibold ${
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-surface rounded-2xl p-6 w-80 shadow-xl">
            ...
            <div className="flex gap-2">
              <button
                className="w-1/2 py-2 bg-disabledBg text-textDark rounded-xl"
      ...
      {showToast && (
        <div className="fixed bottom-32 left-1/2 -translate-x-1/2 bg-primaryLight text-white px-4 py-2 rounded-full shadow-xl font-semibold">
