...
export default function CuentaPage() {
  ...
  // ✅ Evento recibido desde admin → cuenta en proceso
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* ✅ Footer siempre visible si hay pedidos */}
      {items.length > 0 && (
        <div className="fixed bottom-0 left-0 w-full bg-[var(--color-surface)]
         border-t border-[var(--color-border)] shadow-lg">
          <div className="max-w-md mx-auto p-4">
            ...
            {/* ✅ Versión B → Botón bloqueado si ya pidió cuenta */}
            <Button
              fullWidth
      ...
      {showToast && (
        ...
        bg-[var(--color-primary)] text-white px-4 py-2 rounded-full shadow-xl">
