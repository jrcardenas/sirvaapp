...
export default function CuentaPage() {
  ...
  // ✅ Escuchar eventos del camarero y otros clientes
  useEffect(() => {
    const notifyChannel = new BroadcastChannel("notify_channel");
    const pedirCuentaChannel = new BroadcastChannel("pedir_cuenta_channel");
    ...
    pedirCuentaChannel.onmessage = (ev) => {
      const { mesaId: mesa } = ev.data;
      if (mesa === mesaId) {
